...
(function (l, m) {
  ...
  return {
    best: function (g) {
      ...
      for (h = 0; h < f && '' !== g[h]; h++);
      if (h < d)
        for (g.splice(h, 1, '0000'); g.length < d; ) g.splice(h, 0, '0000');
      for (h = 0; h < d; h++) {
        for (var f = g[h].split(''), l = 0; 3 > l; l++)
...
(function (l) {
  ...
  function g(d, e) {
    for (var f = d.length, h = []; f--; ) h[f] = e(d[f]);
    return h;
  }
  function f(d, e) {
    var f = d.split('@'),
  ...
  function n(d, e, f) {
    var h = 0;
    d = f ? q(d / 700) : d >> 1;
    for (d += q(d / e); 455 < d; h += 36) d = q(d / 35);
    return q(h + (36 * d) / (d + 38));
  }
  function D(d) {
    var e = [],
      f = d.length,
    ...
    0 > c && (c = 0);
    for (k = 0; k < c; ++k)
      128 <= d.charCodeAt(k) && m('not-basic'), e.push(d.charCodeAt(k));
    for (c = 0 < c ? c + 1 : 0; c < f; ) {
      k = l;
      g = 1;
      for (p = 36; ; p += 36) {
        ...
        r =
          10 > r - 48
            ...
            ? r - 97
            : 36;
        (36 <= r || r > q((2147483647 - l) / g)) && m('overflow');
        l += r * g;
        y = p <= b ? 1 : p >= b + 26 ? 26 : p - b;
        if (r < y) break;
        r = 36 - y;
        g > q(2147483647 / r) && m('overflow');
        g *= r;
      }
      g = e.length + 1;
      b = n(l - k, g, 0 == k);
      q(l / g) > 2147483647 - a && m('overflow');
      a += q(l / g);
      l %= g;
      e.splice(l++, 0, a);
    }
  ...
  function u(e) {
    ...
    g = 0;
    a = 72;
    for (b = 0; b < y; ++b) (p = e[b]), 128 > p && r.push(t(p));
    for ((h = l = r.length) && r.push('-'); h < y; ) {
      c = 2147483647;
      for (b = 0; b < y; ++b) (p = e[b]), p >= f && p < c && (c = p);
      E = h + 1;
      c - f > q((2147483647 - g) / E) && m('overflow');
      g += (c - f) * E;
      f = c;
      for (b = 0; b < y; ++b)
        if (((p = e[b]), p < f && 2147483647 < ++g && m('overflow'), p == f)) {
          k = g;
          for (c = 36; ; c += 36) {
            p = c <= a ? 1 : c >= a + 26 ? 26 : c - a;
            if (k < p) break;
            I = k - p;
            k = 36 - p;
            r.push(t(w(p + (I % k), 0)));
  ...
  if (z.global === z || z.window === z || z.self === z) l = z;
  var v,
    A = /^xn--/,
    F = /[^\x20-\x7E]/,
    H = /[\x2E\u3002\uFF0E\uFF61]/g,
  ...
  if (
    ...
    else for (x in v) v.hasOwnProperty(x) && (B[x] = v[x]);
  else l.punycode = v;
})(this);
(function (l, m) {
  'object' === typeof module && module.exports
    ...
    : 'function' === typeof define && define.amd
    ? define(m)
    : (l.SecondLevelDomains = m(l));
})(this, function (l) {
  var m = l && l.SecondLevelDomains,
    g = {
      list: {
      ...
      has: function (f) {
        var d = f.lastIndexOf('.');
        if (0 >= d || d >= f.length - 1) return !1;
        var h = f.lastIndexOf('.', d - 1);
        if (0 >= h || h >= d - 1) return !1;
        var l = g.list[f.slice(d + 1)];
        return l ? 0 <= l.indexOf(' ' + f.slice(h + 1, d) + ' ') : !1;
      },
      is: function (f) {
        var d = f.lastIndexOf('.');
      ...
      get: function (f) {
        ...
        var h = f.lastIndexOf('.', d - 1);
        if (0 >= h || h >= d - 1) return null;
        var l = g.list[f.slice(d + 1)];
        return !l || 0 > l.indexOf(' ' + f.slice(h + 1, d) + ' ')
          ? null
          : f.slice(h + 1);
      },
      noConflict: function () {
        l.SecondLevelDomains === this && (l.SecondLevelDomains = m);
        return this;
      },
    };
  return g;
...
(function (l, m) {
  'object' === typeof module && module.exports
    ...
    : (l.URI = m(l.punycode, l.IPv6, l.SecondLevelDomains, l));
})(this, function (l, m, g, f) {
  function d(a, b) {
    var c = 1 <= arguments.length,
      k = 2 <= arguments.length;
    if (!(this instanceof d)) return c ? (k ? new d(a, b) : new d(a)) : new d();
    if (void 0 === a) {
  ...
  function D(a, b) {
    ...
    else if (n(b)) for (d = 0, p = b.length; d < p; d++) c[b[d]] = !0;
    else c[b] = !0;
    d = 0;
  ...
  function B(a, b) {
    if (!n(a) || !n(b) || a.length !== b.length) return !1;
    a.sort();
    b.sort();
  ...
  for (x in t)
    (d[x + 'PathSegment'] = G('pathname', t[x])),
      (d[x + 'UrnPathSegment'] = G('urnpath', t[x]));
  t = function (a, b, c) {
    return function (k) {
      var p;
      p = c
        ...
        : d[b];
      k = (k + '').split(a);
      for (var e = 0, f = k.length; e < f; e++) k[e] = p(k[e]);
      return k.join(a);
    };
  };
  ...
  d.parseUserinfo = function (a, b) {
    var c = a.indexOf('/'),
      k = a.lastIndexOf('@', -1 < c ? c : a.length - 1);
    -1 < k && (-1 === c || k < c)
      ? ((c = a.substring(0, k).split(':')),
  ...
  d.buildQuery = function (a, b, c) {
    ...
    for (e in a)
      if (q.call(a, e) && e)
        if (n(a[e]))
          for (p = {}, f = 0, g = a[e].length; f < g; f++)
            void 0 !== a[e][f] &&
              void 0 === p[a[e][f] + ''] &&
              ((k += '&' + d.buildQueryParameter(e, a[e][f], c)),
              !0 !== b && (p[a[e][f] + ''] = !0));
        else void 0 !== a[e] && (k += '&' + d.buildQueryParameter(e, a[e], c));
  ...
  d.addQuery = function (a, b, c) {
    if ('object' === typeof b)
      for (var k in b) q.call(b, k) && d.addQuery(a, k, b[k]);
  ...
  d.removeQuery = function (a, b, c) {
    var k;
    if (n(b)) for (c = 0, k = b.length; c < k; c++) a[b[c]] = void 0;
    else if ('RegExp' === w(b)) for (k in a) b.test(k) && (a[k] = void 0);
    else if ('object' === typeof b)
      for (k in b) q.call(b, k) && d.removeQuery(a, k, b[k]);
    else if ('string' === typeof b)
      void 0 !== c
        ? 'RegExp' === w(c)
          ? !n(a[b]) && c.test(a[b])
  ...
  d.hasQuery = function (a, b, c, k) {
      ...
      case 'RegExp':
        for (var e in a)
          if (
            q.call(a, e) &&
            b.test(e) &&
            (void 0 === c || d.hasQuery(a, e, c))
          )
            return !0;
        return !1;
      case 'Object':
        for (var f in b) if (q.call(b, f) && !d.hasQuery(a, f, b[f])) return !1;
        return !0;
      default:
        throw new TypeError(
    ...
    switch (w(c)) {
      case 'Undefined':
        return b in a;
      case 'Boolean':
        return (a = !(n(a[b]) ? !a[b].length : !a[b])), c === a;
      case 'Function':
        return !!c(a[b], b, a);
      case 'Array':
        return n(a[b]) ? (k ? u : B)(a[b], c) : !1;
      case 'RegExp':
        return n(a[b]) ? (k ? u(a[b], c) : !1) : !(!a[b] || !a[b].match(c));
      case 'Number':
        c = String(c);
      case 'String':
        return n(a[b]) ? (k ? u(a[b], c) : !1) : a[b] === c;
      default:
        throw new TypeError(
  ...
  d.joinPaths = function () {
    for (var a = [], b = [], c = 0, k = 0; k < arguments.length; k++) {
      var e = new d(arguments[k]);
      a.push(e);
      for (var e = e.segment(), f = 0; f < e.length; f++)
  ...
  d.withinString = function (a, b, c) {
    c || (c = {});
    var k = c.start || d.findUri.start,
      e = c.end || d.findUri.end,
      f = c.trim || d.findUri.trim,
      g = c.parens || d.findUri.parens,
      h = /[a-z0-9-]=["']?$/i;
    for (k.lastIndex = 0; ; ) {
      var l = k.exec(a);
      if (!l) break;
      ...
      for (var q = m + a.slice(m).search(e), n = a.slice(m, q), q = -1; ; ) {
        var t = g.exec(n);
        if (!t) break;
        q = Math.max(q, t.index + t[0].length);
      }
      n = -1 < q ? n.slice(0, q) + n.slice(q).replace(f, '') : n.replace(f, '');
      n.length <= l[0].length ||
        ...
        void 0 === l
          ? (k.lastIndex = q)
          : ((l = String(l)),
            (a = a.slice(0, m) + l + a.slice(q)),
            (k.lastIndex = m + l.length)));
    }
    k.lastIndex = 0;
    return a;
  };
  d.ensureValidHostname = function (a) {
    if (a.match(d.invalid_hostname_characters)) {
      ...
      if (l.toASCII(a).match(d.invalid_hostname_characters))
        throw new TypeError(
  ...
  d.noConflict = function (a) {
    if (a)
      return (
        ...
        f.URITemplate &&
          'function' === typeof f.URITemplate.noConflict &&
          (a.URITemplate = f.URITemplate.noConflict()),
        f.IPv6 &&
          'function' === typeof f.IPv6.noConflict &&
          (a.IPv6 = f.IPv6.noConflict()),
        f.SecondLevelDomains &&
          'function' === typeof f.SecondLevelDomains.noConflict &&
          (a.SecondLevelDomains = f.SecondLevelDomains.noConflict()),
        a
      );
    f.URI === this && (f.URI = H);
    return this;
  ...
  e.href = function (a, b) {
    ...
    if ('string' === typeof a || a instanceof String)
      ...
      for (c in ((k = k ? a._parts : a), k))
        q.call(this._parts, c) && (this._parts[c] = k[c]);
  ...
  e.is = function (a) {
    ...
    this._parts.hostname &&
      ...
      (n = f && d.punycode_expression.test(this._parts.hostname)));
  ...
  e.segmentCoded = function (a, b, c) {
    ...
    if (void 0 === b) {
      ...
      if (n(a)) for (e = 0, f = a.length; e < f; e++) a[e] = d.decode(a[e]);
      else a = void 0 !== a ? d.decode(a) : void 0;
      return a;
    }
    if (n(b)) for (e = 0, f = b.length; e < f; e++) b[e] = d.encode(b[e]);
  ...
  e.normalizeHostname = function (a) {
    this._parts.hostname &&
      (this.is('IDN') && l
        ? (this._parts.hostname = l.toASCII(this._parts.hostname))
        : this.is('IPv6') &&
          m &&
  ...
  e.readable = function () {
    ...
    a._parts.hostname &&
      (a.is('punycode') && l
        ? ((b += l.toUnicode(a._parts.hostname)),
  ...
  e.equals = function (a) {
    ...
    b.query('');
    c.query('');
    if (b.toString() !== c.toString() || f.length !== e.length) return !1;
    ...
    for (g in b)
      if (q.call(b, g)) {
        if (!n(b[g])) {
          if (b[g] !== e[g]) return !1;
        } else if (!B(b[g], e[g])) return !1;
        a[g] = !0;
      }
    for (g in e) if (q.call(e, g) && !a[g]) return !1;
    return !0;
  };
